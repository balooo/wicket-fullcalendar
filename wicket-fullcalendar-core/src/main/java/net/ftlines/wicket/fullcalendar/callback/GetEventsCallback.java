...
public class GetEventsCallback extends AbstractCallback
{
	...
	protected void respond()
	{
		...
		String sid = r.getQueryParameters().getParameterValue(SOURCE_ID).toString();
		DateTime start = new DateTime(Long.valueOf(r.getQueryParameters().getParameterValue("start").toString()));
		DateTime end = new DateTime(Long.valueOf(r.getQueryParameters().getParameterValue("end").toString()));
